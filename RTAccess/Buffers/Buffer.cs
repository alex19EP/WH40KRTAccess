...
/// <summary>
/// One review "buffer": a named, ordered list of text lines the user scrubs through with the buffer keys
...
internal class Buffer
{
    ...
    /// <summary>Called when the buffer becomes active or is navigated — subclasses refresh their lines from
    /// the bound live object here.</summary>
    public virtual void Update() { }

    /// <summary>Called when the buffer is disabled — subclasses clear their bound object so stale data isn't
    /// shown if it's re-enabled.</summary>
    protected virtual void ClearBinding() { }

    /// <summary>Clear and repopulate while preserving the cursor position (so a live refresh during item
    /// navigation doesn't snap the user back to the top).</summary>
