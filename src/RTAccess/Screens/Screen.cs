...
namespace RTAccess.Screens
{
    ...
    public abstract class Screen
    {
        ...
        /// bookkeeping); focus persists by <see cref="Access.Core.Graph.ControlId"/> identity.
        /// Declare nothing while the screen's content doesn't exist yet (a raw-capture screen declares
        /// nothing at all).</summary>
        public virtual void Build(Access.Core.Graph.GraphBuilder b) { }
        ...
        private static readonly RTAccess.Input.InputCategory[] UiOnly = { RTAccess.Input.InputCategory.UI };
        ...
        public virtual System.Collections.Generic.IReadOnlyList<RTAccess.Input.InputCategory> InputCategories => UiOnly;
