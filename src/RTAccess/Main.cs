...
public static class Main {
    ...
    public static bool Load(UnityModManager.ModEntry modEntry) {
        ...
        try {
            ...
            Access.Core.Graph.GraphAnnouncer.PartFilter = (type, part) =>
            ...
            Access.Core.Graph.GraphAnnouncer.ExpandedStateText = expanded =>
                Loc.T(expanded ? "role.expanded" : "role.collapsed");
            Access.Core.Graph.GraphAnnouncer.PositionText = (index, count) =>
            ...
            EventBus.Subscribe(SpaceCombatEvents.Instance);
