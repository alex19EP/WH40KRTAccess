using Access.Core.Graph;   // ControlId
...
namespace RTAccess.UI
{
    ...
    public abstract class Navigator
    {
        ...
        /// action).</summary>
        public virtual void FocusNode(ControlId id, bool announce = true) { }
        ...
        /// tier of its <see cref="ControlId"/>), or null. Used by screens that follow focus onto
