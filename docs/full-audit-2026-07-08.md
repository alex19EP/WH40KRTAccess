...
**Area:** fragility / null-safety · **Files:** `src/Access.Core/GraphNavigator.cs:108-113`,
`src/Access.Core/Graph/KeyGraph.cs:54-64`, `src/RTAccess/Input/InputManager.cs:148-196`,
`src/RTAccess/Main.cs:174-299`
...
**Area:** localization hard rule · **Files:** `src/RTAccess/Accessibility/InteractableDescriber.cs`
...
**Area:** screen coverage · **Files:** `src/RTAccess/Screens/InGameScreen.cs:151-157`,
`src/RTAccess/Screens/SystemMapScreen.cs:149-152`, `src/RTAccess/Input/GameKeybinds.cs:47-59`,
`src/RTAccess/Accessibility/ServiceWindowAnnounce.cs:29-40`
...
**Area:** input · **Files:** `src/Access.Core/GraphNavigator.cs:515-555` vs
`src/RTAccess/Input/InputManager.cs:152`
...
**Area:** UMM lifecycle · **Files:** `src/RTAccess/Main.cs:156-164, 301-311`,
`src/RTAccess/Input/GameKeybinds.cs:81-90`
...
**Area:** Harmony · **Files:** `src/RTAccess/Main.cs:110-111, 139-143`
...
**Area:** parallel-tree leak · **Files:** `src/RTAccess/UI/Proxies/DialogChoiceGate.cs`,
`src/RTAccess/Screens/DialogueScreen.cs:325-350`; exposed:
`src/RTAccess/Screens/MessageBoxScreen.cs:63-67`, `src/RTAccess/Screens/SettingsScreen.cs:76-88`,
`src/RTAccess/Screens/InGameScreen.cs:168-172`
...
**Area:** fragility · **Files:** `src/RTAccess/Screens/InventoryScreen.cs:221,267-278,303-304,329,395`
...
- `src/RTAccess/Combat/CommandDispatch.cs:44-49,176-180` — spoken refusals ("Not your turn.",
  "Path blocked.", …); two dup existing keys (`combat.not_turn_based`,
  `path.preview.cant_reach`).
- `src/RTAccess/Accessibility/TileExplorer.cs:76,99,118,153,157,198,271-286` — cursor feedback
  ("Edge.", "Moving party.", "Unknown tile.", …).
- `src/RTAccess/Exploration/WallTones.cs:136`, `src/RTAccess/Exploration/Sonar.cs:113` — Ctrl+F1/F2
  toggle announcements (keys exist to build them: `overlay.mode_set`, `system.*`,
  `overlay.mode.*`).
- `src/RTAccess/Exploration/ProxyUnit.cs:196`, `src/RTAccess/Exploration/ProxyAreaEffect.cs:98`,
  `src/RTAccess/Exploration/ProxyMapObject.cs:222-226` — browse-label fragments;
  `unit.in_combat`/`areaeffect.*` keys already exist.
- `src/RTAccess/Exploration/Geo.cs:61-64` — `RegionWord` compass/region words (makes
  `where.*`/`geo.*` dead).
- `src/RTAccess/Input/InputBindings.cs:98-100` — the F12 speech self-test is registered
  **outside** `#if DEBUG` and is documented as an end-user first-run check → user-facing
  English in Release.
- `src/RTAccess/Accessibility/ServiceWindowAnnounce.cs:29-40` — hardcoded window names,
...
**Area:** localization / missing keys · **Files:** `src/RTAccess/Main.cs:38-87`,
`src/RTAccess/Input/InputAction.cs:22`, `src/RTAccess/assets/locale/enGB/settings.json`
...
byte-identical `ServiceWindowsVM()` bodies (`src/RTAccess/Screens/JournalScreen.cs:45`,
...
**Area:** inconsistency · **Files:** `src/RTAccess/Screens/CharGenScreen.cs:43-113` vs
`src/RTAccess/Screens/WizardScreen.cs:53-106`
...
**Area:** missed abstraction · **Files:** `src/RTAccess/Screens/DialogueScreen.cs:37-158`,
`src/RTAccess/Screens/BookEventScreen.cs:30-133`
...
**Area:** duplication · **Files:** `src/Access.Core/TextUtil.cs:18` (canonical) vs private copies
in `src/RTAccess/Accessibility/UiTextReader.cs:20,61`,
`src/RTAccess/Accessibility/TooltipViewScraper.cs:31,121`,
`src/RTAccess/Accessibility/BarkEvents.cs:36,67`,
`src/RTAccess/Accessibility/InteractableDescriber.cs:33,504-508`,
`src/RTAccess/Accessibility/GlossaryLinks.cs:28,87`,
`src/RTAccess/Accessibility/TooltipReader.cs:29,324`,
`src/RTAccess/Accessibility/DialogText.cs:18,66`
...
**Area:** duplication · **Files:** `src/RTAccess/Accessibility/InteractableDescriber.cs:480-495`,
`src/RTAccess/Screens/SystemMapScreen.cs:313-325`, `src/RTAccess/Combat/AoEPreview.cs:161-169`
...
**Area:** complexity · **Files:** `src/RTAccess/Main.cs:36-105`
...
**Area:** UMM lifecycle · **Files:** `src/RTAccess/Dev/DevServer.cs:76-106`,
`src/RTAccess/Dev/DevHttpServer.cs:31-59`, `src/RTAccess/Main.cs:301-311`
...
**Area:** reflection · **Files:** `src/RTAccess/Exploration/Scanner.cs:81-84,402-412`
...
**Area:** duplication · **Files:** `src/RTAccess/Screens/InGameScreen.cs:603-609` and
`src/RTAccess/Screens/CharacterInfoScreen.cs:499-512` ("Mirrors InGameScreen.AppendWounds")
...
**Area:** visual parity / duplication · **Files:** `src/RTAccess/Exploration/ProxyUnit.cs:159`,
`src/RTAccess/Screens/InGameScreen.cs:567`, `src/RTAccess/Buffers/UnitBuffer.cs:50`,
`src/RTAccess/Combat/AimParity.cs:129`, `src/RTAccess/Accessibility/HitPredictor.cs:83,195`
...
**Files:** `src/RTAccess/Exploration/ProxyUnit.cs:274-277` and
`src/RTAccess/Exploration/Inspect.cs:73` (three-way ally/enemy/neutral) vs
`src/RTAccess/Accessibility/InteractableDescriber.cs:114` (collapses neutral into "ally").
...
**Files:** `src/RTAccess/Accessibility/SettingsValueAnnounce.cs:22-51`; cross-ref
`src/Access.Core/GraphNodes.cs:296-330`, `src/Access.Core/GraphNavigator.cs:484-497`
...
**Files:** `src/RTAccess/Screens/DialogueScreen.cs:284-299`
...
**Files:** `src/RTAccess/Accessibility/WeaponSetAnnouncer.cs:26-37,60`
...
**Files:** `src/RTAccess/Screens/InGameScreen.cs` (`InitiativeLabel:539`, `PartyLabel:417`,
...
**Files:** `src/RTAccess/Diagnostics/RewiredDump.cs`, `KeybindingsDump.cs`, `ScannerDump.cs`
...
**Files:** `src/RTAccess/Combat/AimReadTap.cs:33-46`, `src/RTAccess/Accessibility/ConsoleMode.cs:47-54`
...
**Files:** `src/RTAccess/RTAccess.csproj:51-52,54-61`
...
**Files:** `src/RTAccess/Combat/AimParity.cs:124-130`
...
**Files:** `src/RTAccess/Settings/INullableSetting.cs:7`, `src/RTAccess/Settings/NullableIntSetting.cs`,
consumer `src/RTAccess/UI/Announcements/AnnouncementRegistry.cs:125-127,154`
...
**Files:** `src/RTAccess/Screens/ColonyManagementScreen.cs:52`
...
**Files:** `src/RTAccess/UI/Navigation.cs:12`, `src/RTAccess/UI/Navigator.cs:14`,
`src/Access.Core/GraphNavigator.cs:17`
