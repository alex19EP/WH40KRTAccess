...
///
/// Ported verbatim from WrathAccess (the sibling WOTR accessibility mod) — pure Win32 COM, zero
/// game coupling. Backs <see cref="SapiSpeech"/> (the SAPI 5 fallback TTS).
/// </summary>
