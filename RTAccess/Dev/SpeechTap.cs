...
/// get only what's new. Ported from WrathAccess (originally TangledeepAccess). DEBUG-only.
///
/// Renamed from WrathAccess's <c>SpeechLog</c> to avoid colliding with our existing
/// <see cref="RTAccess.Accessibility.SpeechLog"/> file logger.
/// </summary>
internal sealed class SpeechTap
{
